    ...
    const promiseTry = () => {
        return new Promise ((resolve,reject) => {
            ...
            [
                ...
                {id:6,radioactivo:false,name:"Napalm",description:"this should not be used",range:"irrelevant",price:"$160",img:"https://www.meme-arsenal.com/memes/ba4a6ca48fb800a51fd51540752607aa.jpg"},
                {id:7,radioactivo:true,name:"Grenade",description:"low range throwable explosive",range:"irrelevant",price:"$2",img:"https://www.meme-arsenal.com/memes/ba4a6ca48fb800a51fd51540752607aa.jpg"},
                {id:8,radioactivo:true,name:"Depleted Uranium",description:"death",range:"irrelevant",price:"$8000",img:"https://www.meme-arsenal.com/memes/ba4a6ca48fb800a51fd51540752607aa.jpg"},
